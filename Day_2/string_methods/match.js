...
let pattern = /love/gi
console.log(string1.match(pattern)) // ["love", "love", "love"]
...
console.log(txt.match(/\d+/g)) // ["2019", "30", "2020"]  // we use  ( + )  for concatnate the value dependent on this array that we get back
/*
